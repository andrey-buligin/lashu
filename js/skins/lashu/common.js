...
CHAKRA.slider = function(){
    $.supersized({
        ...
        slides                  :   homeSliderImages || [           // Slideshow Images
                                            ...
                                            {image : 'images/collage_2.jpg', title : '<div class="slide-content">Fluttering..</div>', thumb : '', url : ''}  
                                    ],
...
CHAKRA.map = function(){
    if($('.map').length > 0)
    {
        ...
        $('.map').each(function(i,e){
            ...
            var image = 'images/skins/lashu/marker.png';
...
$(document).ready(function(){
    ...
    Modernizr.load([
    {
        ...
        nope: 'js/skins/lashu/placeholder.js', 
        complete : function() {
