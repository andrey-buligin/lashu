...
function _ml_open_copy(){
	...
	window.Popup = window.open("'.$_CFG['url_to_cms'].'core/messages/popups/popup.copy_messages.php","","width=500,height=500,scrollbars=yes,resizable=yes");
}
</script>
...
<form action="" method="post" name="mainform">
	...
	<div class="button" style=" margin-bottom:5px;"><input type="submit"  value=" '.__MYL_B_DEL_.' " class="button3" onclick="return delete_elements(\''.$this->add_to_get.'\')" name="delete"></div>
	<br style="clear:both;"/>
