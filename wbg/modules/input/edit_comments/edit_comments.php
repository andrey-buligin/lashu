...
//		$OUT_filter = $free_filter->generate_filter_form();
		...
		$my_list->insert_cell("doc_id","Document", "_insert_doc_name", "width='15%'");
		$my_list->insert_cell("name","User", null, "width='10%'");
		$my_list->insert_cell("text","Text", null, "width='35%'");
		$my_list->insert_cell("email","E-mail", null, "width='15%'");
		$my_list->insert_cell("sql_table_name","Table", null, "width='10%'");
