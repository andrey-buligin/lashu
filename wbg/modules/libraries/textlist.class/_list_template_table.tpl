...
<div style="padding-bottom:25px">
	...
	<div class="button" style="float:right"><input type="submit" style="color:red" value=" Delete objects " name="delete" onclick="return delete_elements(\''.$this->add_to_get.'\')"></div>
	<div class="button"><input type="button" value=" Copy objects " name="copy" onclick="open_popup(\''.$_CFG['url_to_textlist_class']."popup.copy_data.php?id=".$_CFG['current_category']['id']."".'\', 600, 700)"></div>
	<div class="button"><input type="button" value=" Move objects " name="move"  onclick="open_popup(\''.$_CFG['url_to_textlist_class']."popup.move_data.php?id=".$_CFG['current_category']['id']."".'\', 600, 700)"></div>
</div>
